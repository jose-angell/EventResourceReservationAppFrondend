    ...
    <aside className="w-64 bg-white dark:bg-surface-dark border-r border-slate-200 dark:border-slate-800 hidden md:flex flex-col shrink-0 overflow-y-auto">
          <div className="p-6">
            ...
            <nav className="space-y-1">
              ...
              <Link to={"/user/reservations"} className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-primary transition-colors group">
