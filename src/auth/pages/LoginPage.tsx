...
export default function LoginPage({ 
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark text-text-dark dark:text-slate-100 min-h-screen flex items-center justify-center p-4 font-body">
      {/* Contenedor principal más estrecho para el Login */}
        ...
        <div className="bg-white dark:bg-surface-dark rounded-xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
          ...
          <div className="p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Contraseña con enlace de recuperación */}
              <div className="space-y-1.5">
                <div className="flex justify-between items-center ml-1">
                  ...
                  <button 
                    ...
                    className="text-xs font-bold text-secondary hover:text-primary transition-colors bg-transparent border-none p-0 cursor-pointer"
                  >
              ...
              {/* Botón Submit */}
              <Button type="submit" className="w-full py-6 bg-primary hover:bg-primary-dark text-white font-bold rounded-lg shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-2 group text-base">
                Iniciar Sesión
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-white dark:bg-surface-dark text-slate-400 font-medium">O continuar con</span>
              </div>
            </div>

            {/* Botones Sociales */}
            <div className="grid grid-cols-2 gap-4">
              <Button onClick={onGoogleLogin} type="button" variant="outline" className="flex items-center justify-center gap-2 py-6 bg-background-dark dark:bg-slate-900 text-white hover:text-white rounded-lg hover:bg-black transition-colors border-transparent">
              ...
              <Button onClick={onAppleLogin} type="button" variant="outline" className="flex items-center justify-center gap-2 py-6 bg-background-dark dark:bg-slate-900 text-white hover:text-white rounded-lg hover:bg-black transition-colors border-transparent">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="px-8 py-6 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-200 dark:border-slate-800 text-center">
            <p className="text-sm text-slate-600 dark:text-slate-400">
              ¿No tienes cuenta? 
              <Link to="/auth/register" className="text-accent font-bold hover:underline ml-1" >Regístrate</Link>
            </p>
          </div>
        </div>
